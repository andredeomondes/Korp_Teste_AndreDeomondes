...
/// <summary>
/// Usa a própria instância de <see cref="EstoqueApiFixture"/> porque derruba o
/// banco no meio do caminho — o que arruinaria os demais testes.
/// </summary>
public sealed class HealthTests : IClassFixture<EstoqueApiFixture>
{
    private readonly EstoqueApiFixture _api;

    public HealthTests(EstoqueApiFixture api) => _api = api;
